    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom_complet', models.CharField(blank=True, max_length=245, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medecin', models.ForeignKey(db_column='medecin_id', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'patients',
            },
